...
const BUILD = 'v2 baseline (copy of v3 for safe iteration)';
...
app.innerHTML = `
  ...
  <section id="hud">
    <div class="topline">
      <h1>World Printer Lab <span style="font-size:12px;opacity:0.6">v2</span></h1>
      <button id="toggleHud" class="secondary">Hide</button>
    </div>
    <div class="hud-body">
      <p class="note"><b>${BUILD}</b> — safe parallel version. Original stable code remains untouched in root.</p>
      ...
      <div id="status">v2 baseline ready. Choose a recipe or type a command. Improvements coming in this parallel folder.</div>
      <div id="selected">Target: none</div>
    </div>
  </section>
  <aside id="help">v2: Higher-fidelity printer + realistic textures coming. Original workflow preserved.</aside>
`;
...
setPhase('ready');
setTarget('none');
setStatus(`${BUILD}. If you do not see this label, Vercel is serving an old deployment.`);
