...
app.innerHTML = `
  ...
  <section id="hud">
    ...
    <div class="hud-body">
      ...
      <div id="status">Ready. Choose a recipe or type: make a cottage, boat, bridge, cart, tree, stall, campfire.</div>
      <div id="selected">Target: none</div>
    </div>
  </section>
  <aside id="help">Correct loop: print on bed → pick up → move preview → place. Drag to orbit. Tap ground only after pickup.</aside>
`;
...
function createPrinter() {
  ...
  const sign = labelSprite('WORLD PRINTER');
